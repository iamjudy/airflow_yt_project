...
@dag(dag_id='trending_youtube_dag_v1',
    ...
    start_date=datetime(2023, 10, 1, tzinfo=timezone(timedelta(hours=7))),
...
def trending_youtube_dag():
    ...
    fetch_trending_videos_task = fetch_trending_videos(region_code='TW', max_results=200, target_file_path=file_path)
